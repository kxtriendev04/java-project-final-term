...
public class PnlCaiDatTaiKhoan extends javax.swing.JPanel {
    ...
    public PnlCaiDatTaiKhoan(User user) {
        ...
        if(!"".equals(currentUser.getAvatar())){
            lblAvatar.setText("");
            ImageIcon icon = new ImageIcon(getClass().getResource(currentUser.getAvatar()));
            int width = lblAvatar.getWidth() > 0 ? lblAvatar.getWidth() : 150; // Giá trị mặc định
            int height = lblAvatar.getHeight() > 0 ? lblAvatar.getHeight() : 175; // Giá trị mặc định
    ...
    private void initComponents() {
        ...
        lblAvatar.setText("Avatar (Không bắt buộc)");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addComponent(radNam)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(radNu, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(139, 139, 139)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        ...
        if(txtHoTen.isEnabled()){
            ...
            if(error){
                try {
                    ...
                    UserDAO userDAO = new UserDAO();
                    //String username, String fullname, LocalDate birth, boolean gender, String email, String phone, String city
                    userDAO.updateUserByUsernameSetting(username, ht, localDate, gt, email, sdt, dc, path);
                    JOptionPane.showMessageDialog(this, "Sửa thành công", "Thành công", JOptionPane.INFORMATION_MESSAGE);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(PnlCaiDatTaiKhoan.class.getName()).log(Level.SEVERE, null, ex);
                } catch (SQLException ex) {
