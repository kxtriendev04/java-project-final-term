...
public class NewFrame extends javax.swing.JFrame {
    ...
    public NewFrame(Movie movie,User user) {
        try {
            initComponents();
            ...
            if(mvd.isMovieNowShowing(movie.getMovieId())){
                FilmBooking form = new FilmBooking(movie, user);
                setForm(form);
            }
            else {
                FilmBookingNoRealse form = new FilmBookingNoRealse(movie, user);
                setForm(form);
            }
//            FilmBooking form = new FilmBooking(movie, user);
//        form.setMovie(movie);
...
//        jScrollPane.setVerticalScrollBar(new ScrollBar());
//        jPanel.setLayout(new BorderLayout());
//        FilmBooking form = new FilmBooking(movie);
////        form.setMovie(movie);
//        setForm(form);
    }
    private void setForm(JComponent c){
        jPanel.removeAll(); //Xoá toàn bộ các thành phần
        jPanel.add(c); //Thêm form
        jPanel.repaint(); //Cập nhật lại giao diện
        jPanel.revalidate(); //Cập nhật lại bố cục
    }
