 ...
 * @author nguye
 */
public class PnlStaffAcc extends javax.swing.JPanel {

    /**
     * Creates new form PnlUsAcc
     */
    public PnlStaffAcc() throws SQLException, ClassNotFoundException {
        initComponents();
    ...
    public void showData() throws SQLException, ClassNotFoundException {
        ...
        List<User> users = userDAO.getAllCustmers();

        for (User user : users) {
            if(user.getIsDeleted())
                continue;
            boolean isCus = "Customer".equals(user.getRole()); 
            if(!isCus){
                continue;
            }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Quản lý danh sách tài khoản khách hàng");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(btnXoaTim, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhatActionPerformed
        ...
        if(error){
            try {
                ...
                Logger.getLogger(PnlStaffAcc.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnTimMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTimMouseClicked
        ...
        try {
            ...
            for (User user : users) {
                if(user.getIsDeleted())
                    continue;
                boolean isCus = "Custommer".equals(user.getRole());
                if(!isCus){
                    continue;
                }
                Object row[] = new Object[9];  // Đảm bảo khai báo mảng Object để chứa các loại dữ liệu khác nhau
