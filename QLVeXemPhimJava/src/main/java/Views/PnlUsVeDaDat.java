...
public class PnlUsVeDaDat extends javax.swing.JPanel {
    ...
    private void btnTimMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTimMouseClicked
        try {
            ...
            // Lấy dữ liệu hóa đơn và phim
            BookingMovieScheduleDAO bookingMovieDAO = new BookingMovieScheduleDAO();
            BookingMovieSchedule bookingMovie = bookingMovieDAO.getBookingWithMoviesById(id);
            
            // Thêm dữ liệu vào bảng tbBooking
            if(bookingMovie != null){
                Object[] row = new Object[6];
                row[0] = bookingMovie.getBookingId();
                row[1] = bookingMovie.getMovieName();
                row[2] = bookingMovie.getBookingDate();
                row[3] = bookingMovie.getScheduleDate();
                row[4] = bookingMovie.getScheduleStart();
                row[5] = bookingMovie.getAmount();
