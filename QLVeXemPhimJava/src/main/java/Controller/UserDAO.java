...
public class UserDAO extends DatabaseConnection{
    ...
    public List<User> getAllCustmers() throws SQLException, ClassNotFoundException {
        List<User> users = new ArrayList<>();
        // Thực hiện truy vấn cơ sở dữ liệu để lấy danh sách phim
    ...
    public boolean updatePointByUserId(int id, int point) throws ClassNotFoundException, SQLException {
    ...
    public boolean updateUserByUsernameSetting(String username, String fullname, LocalDate birth, boolean gender, String email, String phone, String city, String avatar) throws ClassNotFoundException, SQLException {
        String sql = "UPDATE users SET fullname = ?, birthday = ?, gender = ?, email = ?, phone = ?, city = ?, avatar = ? WHERE username = ?";
        Connection conn = getConnection();
        PreparedStatement pstmt = conn.prepareStatement(sql);
