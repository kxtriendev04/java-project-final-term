...
//        createInvoice(filePath, cinemaName, movieTitle, timeBooking ,room, schedule,address, customerName,bookingId, servicePrice);
    ...
    public boolean createInvoice(String filePath, String cinemaName, String movieTitle, String timeBooking,String room, String schedule, String address ,String customerName,int bookingId,  List<String[]> servicePrice, float totalAmount) {
        try {
...
//            document.add(new Paragraph("Rạp: " + cinemaName, titleFont));
            ...
            document.add(new Paragraph("Số điện thoại: 0966766766", normalFont));
...
//                totalAmount += price;
            ...
            table.addCell(new PdfPCell(new Phrase("Tổng tiền đã áp dụng giảm giá", tableFont)));
